...
(function () {
    var I18N = {
        ru: {
            ...
            dl_rustore_sub: "Android · автообновление",
            dl_rustore_badge: "рекомендуем",
            ...
            apk_note: "<strong>Как поставить APK:</strong> открой файл на телефоне → если попросит, разреши «установку из неизвестных источников» для браузера/проводника → установить. Проще — поставить из RuStore: обновления придут сами.",
        ...
        en: {
            ...
            dl_rustore_sub: "Android · auto-updates",
            dl_rustore_badge: "recommended",
            ...
            apk_note: "<strong>Installing the APK:</strong> open the file on your phone → if asked, allow “install from unknown sources” for your browser/file manager → install. Easier still — install from RuStore and updates arrive on their own.",
